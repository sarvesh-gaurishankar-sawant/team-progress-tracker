...
const Sidebar: React.FC<BoardComponentProps> = ({ userId }) => {
    ...
    return (
        <div className="relative flex grow flex-col bg-gray-800 h-screen w-3/12 overflow-x-hidden border border-gray-900">
            <div className="">
                ...
                <div className="flex flex-col mt-24">
                    <div className="w-full">
                        <div className="text-center mb-10 uppercase text-slate-400 text-xs font-bold font-['Plus Jakarta Sans'] w-1/2 mx-auto tracking-[2.40px]">
                            all boards ({totalBoards})
                        </div>
                        {boards.map((board, index) => (
                            <button key={index} className={`w-full mt-2 mb-4 h-12 text-hm rounded-full rounded-l-none flex bg-purple-500 text-white uppercase items-center justify-center
                            ${
                ...
                <div className="absolute inset-x-0 bottom-10 text-center">
                    <button className="flex items-center justify-center h-12 w-[20rem] bg-[#625FC7] text-white rounded-full py-2 px-4 mx-auto">
                    ...
                    <button className="mt-4 flex items-center justify-center h-12 w-[20rem] bg-[#625FC7] text-white rounded-full py-2 px-4 mx-auto">
                        <svg
                            width="18"
                            height="16"
