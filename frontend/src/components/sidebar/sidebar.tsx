                ...
                <div className={`fixed flex flex-col bg-gray-800 h-screen w-3/5 sm:w-1/5 border border-gray-900`}>
                    <div className="h-screen">
                        ...
                        <div className="absolute inset-x-0 bottom-10 text-center">
                            {boardData.name !== "" && location.pathname !== "/board" &&<div className="flex border border-gray-600 mb-8 items-center justify-center h-12 w-full bg-[#625FC7] text-white rounded-full py-2 px-4 mx-auto hover:bg-purple-400">
