    ...
    return (
        <div className="relative flex grow flex-col bg-gray-800 h-screen w-3/12 overflow-x-hidden border border-gray-900">
            <div className="">
                ...
                <div className="flex flex-col mt-24 border border-gray-600">
                    <div className="w-full ">
                        ...
                        {boards.map((board, index) => (
                            <button key={index} className={`w-full h-12 border border-gray-600 text-hm rounded-full rounded-l-none flex bg-purple-500 text-white uppercase items-center justify-center
                            ${
                ...
                <div className="absolute inset-x-0 bottom-10 text-center">
                    <button className="flex items-center justify-center h-12 w-[20rem] bg-[#625FC7] text-white rounded-full py-2 px-4 mx-auto hover:bg-purple-400">
                    ...
                    <button className="mt-4 flex items-center justify-center h-12 w-[20rem] bg-[#625FC7] text-white rounded-full py-2 px-4 mx-auto hover:bg-purple-400">
                        <svg
                            width="18"
                            height="16"
